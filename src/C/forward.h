...
static TTMERR collectescaped(TTM* ttm, utf8** cp8p, VString* dst);
static const char* sv(Function* f);
static TTMERR peek(VString* vs, size_t n, utf8** pp);
static void initglobals();
static void usage(const char* msg);
static int readline(TTM* ttm, TTMFILE* f, VString* buf);
static void readfile(TTM* ttm, const char* fname, VString* buf);
